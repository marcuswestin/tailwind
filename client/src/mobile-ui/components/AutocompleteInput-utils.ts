...
export function interpolateStyle(styles: CSSStyleDeclaration, attr: string, subattr: string = ''): string {
  ...
  return ['Top', 'Right', 'Bottom', 'Left']
    .map(dir => styles[(attr + dir + subattr) as keyof CSSStyleDeclaration])
    .join(' ')
}
